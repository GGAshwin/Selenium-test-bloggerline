...
def write_post_and_delete():
    elem = driver.find_element(By.XPATH, '//*[@id="root"]/div[1]/div[2]/ul/li[2]/a')
    elem.click()
    time.sleep(2)
    tag_filed = driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/form/div[1]/div/div[2]/input')
    tag_filed.send_keys('TestTag')
    tag_filed.send_keys(Keys.RETURN)
    title_filed = driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/form/div[1]/input[2]')
    title_filed.send_keys("Test title from Selenium")
    story_text = driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/form/div[2]/textarea')
    ...
    submit_button.click()
    time.sleep(3)
    delete_post = driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[1]/h1/div/i[2]')
    delete_post.click()
    time.sleep(5)
    driver.close()
